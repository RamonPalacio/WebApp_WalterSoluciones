...
import 'package:walte_soluciones/database/mixin/mixin_user.dart';
import 'package:walte_soluciones/database/mixin/mixin_sms.dart';
import 'package:walte_soluciones/models/model_coordenadas.dart';
import 'package:walte_soluciones/models/model_trakermap.dart';
import 'mixin/mixin_getcoordenada.dart';

class EndPointApi with GetCoordenadas, Users, SendSMS {
  EndPointApi();
